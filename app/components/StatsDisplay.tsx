  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 py-8 flex flex-col gap-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {/* WPM Card */}
        <div className="bg-zinc-950/50 border border-zinc-800 rounded-2xl p-5 text-center relative overflow-hidden group">
          ...
          <p className="text-[10px] text-zinc-400 mt-2">Words Per Minute</p>
        </div>
        ...
        <div className="bg-zinc-950/50 border border-zinc-800 rounded-2xl p-5 text-center relative overflow-hidden group">
          ...
          <p className="text-[10px] text-zinc-400 mt-2">Correct keystrokes</p>
        </div>
        ...
        <div className="bg-zinc-950/50 border border-zinc-800 rounded-2xl p-5 text-center relative overflow-hidden group">
          ...
          <p className="text-[10px] text-zinc-400 mt-2">Missed keystrokes</p>
        </div>
        ...
        <div className="bg-zinc-950/50 border border-zinc-800 rounded-2xl p-5 text-center relative overflow-hidden group">
          ...
          <p className="text-4xl md:text-5xl font-black text-white font-mono">
            {elapsedTime}s
          </p>
          <p className="text-[10px] text-zinc-400 mt-2">Total elapsed duration</p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-zinc-950/20 border border-zinc-800/60 rounded-2xl p-6">
        <div>
          <h4 className="text-sm font-semibold text-white mb-1">Test Completed Successfully!</h4>
